const { NightTimeReplyStrategy, CapsLockReplyStrategy, SentanceBasedReplyStrategy } = require("./reply_strategies");
const { SimilarityScoreStrategy, WordScoreStrategy } = require("./score_strategies");
